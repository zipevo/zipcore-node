...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    zipd.spawn.datadir.should.equal(home + '/.zip');
    zipd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.zip/zipd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.zipd.spawn.datadir.should.equal('./data2');
  });
});
